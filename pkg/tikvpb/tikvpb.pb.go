...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bcc4b74d43acbc27, []int{0}
}
...
type BatchCommandsRequest_Request struct {
	...
	//	*BatchCommandsRequest_Request_VertifyReadSet
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bcc4b74d43acbc27, []int{0, 0}
}
...
type BatchCommandsRequest_Request_VertifyReadSet struct {
	VertifyReadSet *kvrpcpb.VertifyReadSetRequest `protobuf:"bytes,35,opt,name=VertifyReadSet,oneof"`
}
...
func (*BatchCommandsRequest_Request_VertifyReadSet) isBatchCommandsRequest_Request_Cmd()      {}
...
func (m *BatchCommandsRequest_Request) GetVertifyReadSet() *kvrpcpb.VertifyReadSetRequest {
	if x, ok := m.GetCmd().(*BatchCommandsRequest_Request_VertifyReadSet); ok {
		return x.VertifyReadSet
	}
	return nil
}
...
func (*BatchCommandsRequest_Request) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsRequest_Request_OneofMarshaler, _BatchCommandsRequest_Request_OneofUnmarshaler, _BatchCommandsRequest_Request_OneofSizer, []interface{}{
		...
		(*BatchCommandsRequest_Request_VertifyReadSet)(nil),
...
func _BatchCommandsRequest_Request_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsRequest_Request_VertifyReadSet:
		_ = b.EncodeVarint(35<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.VertifyReadSet); err != nil {
			return err
		}
...
func _BatchCommandsRequest_Request_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 34: // cmd.RawCoprocessor
		...
		return true, err
	case 35: // cmd.VertifyReadSet
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(kvrpcpb.VertifyReadSetRequest)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsRequest_Request_VertifyReadSet{msg}
		return true, err
	case 255: // cmd.Empty
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bcc4b74d43acbc27, []int{1}
}
...
type BatchCommandsResponse_Response struct {
	...
	//	*BatchCommandsResponse_Response_VertifyReadSet
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bcc4b74d43acbc27, []int{1, 0}
}
...
type BatchCommandsResponse_Response_VertifyReadSet struct {
	VertifyReadSet *kvrpcpb.VertifyReadSetResponse `protobuf:"bytes,35,opt,name=VertifyReadSet,oneof"`
}
...
func (*BatchCommandsResponse_Response_VertifyReadSet) isBatchCommandsResponse_Response_Cmd()      {}
...
func (m *BatchCommandsResponse_Response) GetVertifyReadSet() *kvrpcpb.VertifyReadSetResponse {
	if x, ok := m.GetCmd().(*BatchCommandsResponse_Response_VertifyReadSet); ok {
		return x.VertifyReadSet
	}
	return nil
}
...
func (*BatchCommandsResponse_Response) XXX_OneofFuncs() (func(msg proto.Message, b *proto.Buffer) error, func(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error), func(msg proto.Message) (n int), []interface{}) {
	return _BatchCommandsResponse_Response_OneofMarshaler, _BatchCommandsResponse_Response_OneofUnmarshaler, _BatchCommandsResponse_Response_OneofSizer, []interface{}{
		...
		(*BatchCommandsResponse_Response_VertifyReadSet)(nil),
...
func _BatchCommandsResponse_Response_OneofMarshaler(msg proto.Message, b *proto.Buffer) error {
	...
	case *BatchCommandsResponse_Response_VertifyReadSet:
		_ = b.EncodeVarint(35<<3 | proto.WireBytes)
		if err := b.EncodeMessage(x.VertifyReadSet); err != nil {
			return err
		}
...
func _BatchCommandsResponse_Response_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 35: // cmd.VertifyReadSet
		...
		msg := new(kvrpcpb.VertifyReadSetResponse)
		err := b.DecodeMessage(msg)
		m.Cmd = &BatchCommandsResponse_Response_VertifyReadSet{msg}
		return true, err
	case 255: // cmd.Empty
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bcc4b74d43acbc27, []int{2}
}
...
func (*BatchCommandsEmptyRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bcc4b74d43acbc27, []int{3}
}
...
func (*BatchCommandsEmptyResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_bcc4b74d43acbc27, []int{4}
}
...
type TikvClient interface {
	...
	VertifyReadSet(ctx context.Context, in *kvrpcpb.VertifyReadSetRequest, opts ...grpc.CallOption) (*kvrpcpb.VertifyReadSetResponse, error)
...
func (c *tikvClient) VertifyReadSet(ctx context.Context, in *kvrpcpb.VertifyReadSetRequest, opts ...grpc.CallOption) (*kvrpcpb.VertifyReadSetResponse, error) {
	out := new(kvrpcpb.VertifyReadSetResponse)
	err := c.cc.Invoke(ctx, "/tikvpb.Tikv/VertifyReadSet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TikvServer interface {
	...
	VertifyReadSet(context.Context, *kvrpcpb.VertifyReadSetRequest) (*kvrpcpb.VertifyReadSetResponse, error)
...
func _Tikv_VertifyReadSet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(kvrpcpb.VertifyReadSetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TikvServer).VertifyReadSet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/tikvpb.Tikv/VertifyReadSet",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TikvServer).VertifyReadSet(ctx, req.(*kvrpcpb.VertifyReadSetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Tikv_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "VertifyReadSet",
			Handler:    _Tikv_VertifyReadSet_Handler,
		},
		{
...
func (m *BatchCommandsRequest_Request_VertifyReadSet) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.VertifyReadSet != nil {
		dAtA[i] = 0x9a
		i++
		dAtA[i] = 0x2
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.VertifyReadSet.Size()))
		n32, err := m.VertifyReadSet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *BatchCommandsRequest_Request_Empty) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Empty != nil {
		...
		n33, err := m.Empty.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n33
...
func (m *BatchCommandsResponse_Response) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if m.Cmd != nil {
		nn36, err := m.Cmd.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += nn36
...
func (m *BatchCommandsResponse_Response_Scan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Scan != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Scan.Size()))
		n38, err := m.Scan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n38
...
func (m *BatchCommandsResponse_Response_Prewrite) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Prewrite != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Prewrite.Size()))
		n39, err := m.Prewrite.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n39
...
func (m *BatchCommandsResponse_Response_Commit) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Commit != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Commit.Size()))
		n40, err := m.Commit.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n40
...
func (m *BatchCommandsResponse_Response_Cleanup) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Cleanup != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Cleanup.Size()))
		n42, err := m.Cleanup.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n42
...
func (m *BatchCommandsResponse_Response_BatchGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BatchGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.BatchGet.Size()))
		n43, err := m.BatchGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n43
...
func (m *BatchCommandsResponse_Response_BatchRollback) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.BatchRollback != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.BatchRollback.Size()))
		n44, err := m.BatchRollback.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n44
...
func (m *BatchCommandsResponse_Response_ScanLock) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ScanLock != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.ScanLock.Size()))
		n45, err := m.ScanLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n45
...
func (m *BatchCommandsResponse_Response_ResolveLock) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ResolveLock != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.ResolveLock.Size()))
		n46, err := m.ResolveLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n46
...
func (m *BatchCommandsResponse_Response_RawGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawGet.Size()))
		n49, err := m.RawGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n49
...
func (m *BatchCommandsResponse_Response_RawBatchGet) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchGet != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchGet.Size()))
		n50, err := m.RawBatchGet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n50
...
func (m *BatchCommandsResponse_Response_RawPut) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawPut != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawPut.Size()))
		n51, err := m.RawPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n51
...
func (m *BatchCommandsResponse_Response_RawBatchPut) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchPut != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchPut.Size()))
		n52, err := m.RawBatchPut.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n52
...
func (m *BatchCommandsResponse_Response_RawDelete) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawDelete != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawDelete.Size()))
		n53, err := m.RawDelete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n53
...
func (m *BatchCommandsResponse_Response_RawBatchDelete) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchDelete != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchDelete.Size()))
		n54, err := m.RawBatchDelete.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n54
...
func (m *BatchCommandsResponse_Response_RawScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawScan != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawScan.Size()))
		n55, err := m.RawScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n55
...
func (m *BatchCommandsResponse_Response_RawDeleteRange) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawDeleteRange != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawDeleteRange.Size()))
		n56, err := m.RawDeleteRange.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n56
...
func (m *BatchCommandsResponse_Response_RawBatchScan) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawBatchScan != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawBatchScan.Size()))
		n57, err := m.RawBatchScan.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n57
...
func (m *BatchCommandsResponse_Response_Coprocessor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Coprocessor != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Coprocessor.Size()))
		n58, err := m.Coprocessor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n58
...
func (m *BatchCommandsResponse_Response_PessimisticLock) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PessimisticLock != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.PessimisticLock.Size()))
		n59, err := m.PessimisticLock.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n59
...
func (m *BatchCommandsResponse_Response_PessimisticRollback) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.PessimisticRollback != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.PessimisticRollback.Size()))
		n60, err := m.PessimisticRollback.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n60
...
func (m *BatchCommandsResponse_Response_CheckTxnStatus) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CheckTxnStatus != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.CheckTxnStatus.Size()))
		n61, err := m.CheckTxnStatus.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n61
...
func (m *BatchCommandsResponse_Response_TxnHeartBeat) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.TxnHeartBeat != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.TxnHeartBeat.Size()))
		n62, err := m.TxnHeartBeat.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n62
...
func (m *BatchCommandsResponse_Response_CheckSecondaryLocks) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CheckSecondaryLocks != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.CheckSecondaryLocks.Size()))
		n63, err := m.CheckSecondaryLocks.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n63
...
func (m *BatchCommandsResponse_Response_RawCoprocessor) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.RawCoprocessor != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.RawCoprocessor.Size()))
		n64, err := m.RawCoprocessor.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n64
...
func (m *BatchCommandsResponse_Response_VertifyReadSet) MarshalTo(dAtA []byte) (int, error) {
	i := 0
	if m.VertifyReadSet != nil {
		dAtA[i] = 0x9a
		i++
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.VertifyReadSet.Size()))
		n65, err := m.VertifyReadSet.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n65
...
func (m *BatchCommandsResponse_Response_Empty) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Empty != nil {
		...
		i++
		i = encodeVarintTikvpb(dAtA, i, uint64(m.Empty.Size()))
		n66, err := m.Empty.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n66
...
func (m *BatchCommandsRequest_Request_VertifyReadSet) Size() (n int) {
	var l int
	_ = l
	if m.VertifyReadSet != nil {
		l = m.VertifyReadSet.Size()
		n += 2 + l + sovTikvpb(uint64(l))
	}
	return n
}
...
func (m *BatchCommandsResponse_Response_VertifyReadSet) Size() (n int) {
	var l int
	_ = l
	if m.VertifyReadSet != nil {
		l = m.VertifyReadSet.Size()
...
func (m *BatchCommandsRequest_Request) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 35:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VertifyReadSet", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &kvrpcpb.VertifyReadSetRequest{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsRequest_Request_VertifyReadSet{v}
			iNdEx = postIndex
		case 255:
			if wireType != 2 {
...
func (m *BatchCommandsResponse_Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 35:
			...
			v := &kvrpcpb.VertifyReadSetResponse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Cmd = &BatchCommandsResponse_Response_VertifyReadSet{v}
			iNdEx = postIndex
		case 255:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Empty", wireType)
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_bcc4b74d43acbc27) }

var fileDescriptor_tikvpb_bcc4b74d43acbc27 = []byte{
	// 2215 bytes of a gzipped FileDescriptorProto
	,
}
