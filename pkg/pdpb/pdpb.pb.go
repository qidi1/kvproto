...
type RegionHeartbeatRequest struct {
	...
	// QueryStats reported write query stats, and there are read query stats in
	// store heartbeat
	QueryStats *QueryStats `protobuf:"bytes,16,opt,name=query_stats,json=queryStats,proto3" json:"query_stats,omitempty"`
	// cpu_usage is the CPU time usage of the leader region since the last
	// heartbeat, which is calculated by
	// cpu_time_delta/heartbeat_reported_interval.
...
type StoreStats struct {
	...
	// Score that represents the speed of the store, ranges in [1, 100], lower is
	// better.
...
type StoreHeartbeatRequest struct {
	...
	// Detailed store report that is only filled up on PD's demand for online
	// unsafe recover.
...
func (m *RecoveryPlan) GetDeletes() []uint64 {
	if m != nil {
		return m.Deletes
	}
	return nil
...
type ScatterRegionRequest struct {
	...
	// If group is defined, the regions with the same group would be scattered as
	// a whole group. If not defined, the regions would be scattered in a cluster
	// level.
...
type SyncRegionResponse struct {
	...
	QueryStats           []*QueryStats     `protobuf:"bytes,7,rep,name=query_stats,json=queryStats,proto3" json:"query_stats,omitempty"`
	XXX_NoUnkeyedLiteral struct{}          `json:"-"`
	XXX_unrecognized     []byte            `json:"-"`
	XXX_sizecache        int32             `json:"-"`
}
...
func (m *SyncRegionResponse) GetQueryStats() []*QueryStats {
	if m != nil {
		return m.QueryStats
	}
	return nil
...
type SyncMaxTSRequest struct {
	...
	// If skip_check is true, the sync will try to write the max_ts without
	// checking whether it's bigger.
...
type GetDCLocationInfoResponse struct {
	...
	// max_ts will be included into this response if PD leader think the receiver
	// needs, which it's set when the number of the max suffix bits changes.
...
var fileDescriptor_78b27e6f04f44c6e = []byte{
	...
	,
}
...
func (m *RecoveryPlan) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Deletes) > 0 {
		dAtA93 := make([]byte, len(m.Deletes)*10)
		var j92 int
		for _, num := range m.Deletes {
			for num >= 1<<7 {
...
func (m *ScatterRegionRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RegionsId) > 0 {
		dAtA98 := make([]byte, len(m.RegionsId)*10)
		var j97 int
...
func (m *SyncRegionResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.QueryStats) > 0 {
		for iNdEx := len(m.QueryStats) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.QueryStats[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *SplitAndScatterRegionsResponse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.RegionsId) > 0 {
		dAtA124 := make([]byte, len(m.RegionsId)*10)
		var j123 int
		for _, num := range m.RegionsId {
			for num >= 1<<7 {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Deletes) == 0 {
					m.Deletes = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
...
func (m *SyncRegionResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if err := m.QueryStats[len(m.QueryStats)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
